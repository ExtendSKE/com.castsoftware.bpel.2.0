...
class ExtensionApplication(cast.application.ApplicationLevelExtension):
    ...
    def end_application(self, application):
        ...
        resourceReferences = list(application.search_objects(category='BPEL', load_properties=False))
        resourceReferences1 = list(application.search_objects(category='Java', load_properties=False))
